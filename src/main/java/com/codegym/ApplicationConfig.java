...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public IMobileTypeService mobileTypeService() {
        return new MobileTypeServiceImpl();
    }
    @Bean
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/csphone1?useUnicode=yes&characterEncoding=UTF-8");
        dataSource.setUsername("root");
        dataSource.setPassword("Giabaoproo@347");
        return dataSource;
    }
